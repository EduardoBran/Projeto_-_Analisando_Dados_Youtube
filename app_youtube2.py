...
total_de_inscritos = st.number_input("Total de Inscritos", min_value=1, max_value=289000000.0, step=1)
total_de_visualizacoes = st.number_input("Total de Visualizações", min_value=1, max_value=1.040056e+11, step=1)
pais = st.selectbox("País", options=paises)
idade_do_canal = st.number_input("Idade do Canal (anos)", min_value=1, max_value=19, step=1)
total_de_visualizacoes_ultimos_30_dias = st.number_input("Visualizações Últimos 30 Dias", min_value=1, max_value=3.592000e+09, step=1)
total_de_inscritos_ultimos_30_dias = st.number_input("Inscritos Últimos 30 Dias", min_value=1, max_value=27000000.0, step=1)
